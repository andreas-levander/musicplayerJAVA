...
public class SoundClipPlayer implements Runnable {
	...
	// will go to sleep until there is a Uppgift1.SoundClip to retrieve
	// from the queue.
	...
	private synchronized void playClips(){
		...
		try {
			...
			SoundClip sc = clips.remove(0); // Remove the first Uppgift1.SoundClip from the list
			...
			// when the play back of the current Uppgift1.SoundClip has ended.
			//
